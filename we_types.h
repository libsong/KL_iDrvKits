...
extern void Qstring2char(QString  str, char *c);
...
class QFolderAndFilesOp
{
public:
	QFolderAndFilesOp();
	~QFolderAndFilesOp();

	void clearFolder(const QString &folderFullPath,bool bRmFolder);
